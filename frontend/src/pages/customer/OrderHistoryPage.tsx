  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 dark:bg-gray-900">
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-lg font-bold text-gray-900 dark:text-gray-100">點餐紀錄</h1>
        <Link to="/order" className="text-sm text-blue-600 dark:text-blue-400">
          返回點餐
        </Link>
      </div>
      ...
      <div className="space-y-4">
        {orders.map((order) => {
          ...
          return (
            <div key={order.id} className="rounded-xl bg-white shadow-sm dark:bg-gray-800">
              <button
              ...
              {expanded && (
                <div className="border-t px-4 pb-4 dark:border-gray-700">
